...
35. history-card entity-card zero-strong-slot `다시 불러오기` 후 downgraded verification badge(`설명 카드`), `설명형 단일 출처` verification label, `백과 기반` source role이 과장 없이 유지되는지 확인
