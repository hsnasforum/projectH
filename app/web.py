...
class WebAppService(AggregateHandlerMixin, FeedbackHandlerMixin, PreferenceHandlerMixin, SerializerMixin):
    def __init__(
        self,
    ...
    # -- Feedback/correction (see app.handlers.feedback) --
    ...
    # -- Candidate/aggregate (see app.handlers.aggregate) --
