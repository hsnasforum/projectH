...
- entity-card zero-strong-slot natural-reload follow-up response-origin continuity service + browser smoke covering `설명 카드` answer-mode badge, `설명형 단일 출처`, `백과 기반` drift prevention
