...
- entity-card 붉은사막 actual-search browser natural-reload follow-up response-origin continuity smoke covering `WEB` badge, `설명 카드`, `설명형 다중 출처 합의`, `백과 기반` drift prevention
...
- entity-card 붉은사막 actual-search browser natural-reload follow-up source-path plurality smoke covering `namu.wiki` and `ko.wikipedia.org` in context box after natural reload + follow-up
...
- entity-card 붉은사막 actual-search natural-reload second-follow-up source-path + response-origin continuity service + browser smoke covering `namu.wiki`, `ko.wikipedia.org`, `WEB` badge, `설명 카드`, `설명형 다중 출처 합의`, `백과 기반` after natural reload + second follow-up
