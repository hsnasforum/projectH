...
- search-only response browser smoke with transcript preview cards, hidden body text, `selected-copy` button visibility/click/notice/clipboard regression coverage, and full-path tooltip on preview card filenames in both response detail and transcript
