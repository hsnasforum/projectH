...
- not implemented:
  ...
  - durable preference memory (accepted reviewed candidates are now persisted as local preference candidates through the existing preference store; activation and cross-session application remain not-implemented)
