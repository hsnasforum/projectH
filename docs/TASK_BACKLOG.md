...
13. Search-only response Playwright smoke coverage with `selected-copy` button visibility/click/notice/clipboard regression and full-path tooltip on preview card filenames
