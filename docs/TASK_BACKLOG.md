...
84. Browser file picker readable text-layer PDF success summary Playwright smoke coverage (OCR guidance 미노출, visible summary body with extracted text `local-first approval-based document assistant`, context box + quick meta `readable-text-layer.pdf`, `문서 요약` label)
