...
9. PDF text-layer handling (readable → visible summary body with `문서 요약` label) and OCR-not-supported guidance (scanned/image-only → visible `요약할 수 없습니다`, `OCR`, `이미지형 PDF`, `다음 단계:`)
