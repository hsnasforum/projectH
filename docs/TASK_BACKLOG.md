...
10. Permission-gated web investigation with local JSON history (in-session reload, history-card badges: answer-mode badges, color-coded verification-strength badges, color-coded source-role trust badges), entity-card / latest-update answer-mode distinction with separate verification labels and entity-card strong-badge downgrade
