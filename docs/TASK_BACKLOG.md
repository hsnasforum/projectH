...
13. Search-only response Playwright smoke coverage with `selected-copy` button visibility/click/notice/clipboard regression, full-path tooltip on preview card filenames, and match-type badge plus content snippet visibility
