...
43. Entity-card zero-strong-slot click-reload second-follow-up response-origin + source-path continuity Playwright smoke + natural-reload service coverage (`WEB` badge, `설명 카드`, `설명형 단일 출처`, `백과 기반`, `namu.wiki`, `ko.wikipedia.org` drift prevention)
