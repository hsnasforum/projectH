...
43. Entity-card zero-strong-slot natural-reload follow-up response-origin continuity service + Playwright smoke coverage (`설명 카드`, `설명형 단일 출처`, `백과 기반` drift prevention)
