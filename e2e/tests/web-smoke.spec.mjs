...
test("entity-card 붉은사막 actual-search 자연어 reload 후 follow-up에서 source path가 context box에 유지됩니다", async ({ page }) => {
...
test("entity-card 붉은사막 actual-search 자연어 reload 후 follow-up에서 response origin badge와 answer-mode badge가 drift하지 않습니다", async ({ page }) => {
