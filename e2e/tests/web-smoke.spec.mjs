  ...
  await page.evaluate(() => {
    ...
    renderSearchHistory([
      ...
      },
      {
        ...
        source_roles: ["공식 기반"],
        claim_coverage_summary: { strong: 2 },
        result_count: 4,
        page_count: 2,
        created_at: new Date().toISOString(),
      },
      {
        ...
        verification_label: "공식+기사 교차 확인",
        source_roles: ["공식 기반"],
        claim_coverage_summary: { strong: 2, weak: 1 },
...
test("history-card entity-card 다시 불러오기 클릭 후 WEB badge, 설명 카드, 설명형 단일 출처, 백과 기반이 유지됩니다", async ({ page }) => {
      ...
      items: [
        {
          ...
          claim_coverage_summary: { strong: 0, weak: 1, missing: 1 },
          claim_coverage_progress_summary: "단일 출처 상태 1건, 미확인 1건.",
        },
      ],
    }
  ...
  // `claim_coverage_summary` ({weak: 1, missing: 1} → `단일 출처 1 · 미확인 1`) as the first
      ...
      items: [
        {
          ...
          created_at: record.created_at,
          record_path: recordPath,
          claim_coverage_summary: { strong: 0, weak: 1, missing: 0 },
          claim_coverage_progress_summary: "단일 출처 상태 1건.",
        },
      ],
    }
      ...
      items: [
        {
          ...
          created_at: record.created_at,
          record_path: recordPath,
          claim_coverage_summary: { strong: 1, weak: 4, missing: 0 },
          claim_coverage_progress_summary: "",
        },
      ],
    }
...
test("history-card entity-card store-seeded actual-search initial-render 단계에서 serialized zero-count empty-meta no-leak contract가 유지됩니다", async ({ page }) => {
  ...
  // produce for this path (`claim_coverage_summary: { strong: 0, weak: 0, missing: 0 }`,
