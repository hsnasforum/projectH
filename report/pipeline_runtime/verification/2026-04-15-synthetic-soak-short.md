...
## 요약
- project=/tmp/projecth-pipeline-runtime-synthetic-dxpfg3ys
- session=aip-projecth-pipeline-runtime-synthetic-dxpfg3ys
- mode=experimental
- duration_sec=30.0
- samples=33
...
- workspace_cleanup=background_delete_requested(pid=2637691)
